...
// you can increase or decrease this value to get different effects
    ...
    window.setInterval(function(){
        ...
        imgelm.setAttribute('src','http://lorempixel.com/800/400/sports/');
        slideshow.appendChild(imgelm);
        images          = document.getElementById('slideshow').getElementsByTagName('img'),
            numberOfImages  = images.length;


        for(var lnb=0;lnb<numberOfImages;lnb++){
            images[lnb].className = (i==lnb)?"fx":"";
        }
...
// if it is set to 1 (instead of 0) it is because the first image is styled when the page loads
    ...
    function kenBurns() {
        ...
        countelm.textContent="current:"+i+"of"+numberOfImages;
        if (numberOfImages<3){
            countelm.textContent="waiting to have 3";
            return;
        }
